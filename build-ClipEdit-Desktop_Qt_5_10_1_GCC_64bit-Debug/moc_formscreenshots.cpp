...
QT_MOC_LITERAL(1, 16, 14), // "dimensionsMade"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 12), // "itemInserted"
QT_MOC_LITERAL(4, 45, 15), // "mousePressEvent"
QT_MOC_LITERAL(5, 61, 17), // "mouseReleaseEvent"
QT_MOC_LITERAL(6, 79, 8), // "snapshot"
QT_MOC_LITERAL(7, 88, 14), // "CaptureDesktop"
QT_MOC_LITERAL(8, 103, 11), // "CaptureArea"
QT_MOC_LITERAL(9, 115, 3), // "val"
QT_MOC_LITERAL(10, 119, 1), // "a"
QT_MOC_LITERAL(11, 121, 10), // "updatehide"
QT_MOC_LITERAL(12, 132, 13), // "setBackground"
QT_MOC_LITERAL(13, 146, 3) // "pix"

    },
    "FormScreenshots\0dimensionsMade\0\0"
    "itemInserted\0mousePressEvent\0"
    "mouseReleaseEvent\0snapshot\0CaptureDesktop\0"
    "CaptureArea\0val\0a\0updatehide\0setBackground\0"
    "pix"
};
...
static const uint qt_meta_data_FormScreenshots[] = {
 ...
 // slots: parameters
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Void, QMetaType::Bool, QMetaType::QRect,    9,   10,
    QMetaType::Void,
...
void FormScreenshots::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dimensionsMade((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< QRect(*)>(_a[2]))); break;
        case 1: _t->itemInserted(); break;
        case 2: _t->mousePressEvent(); break;
        case 3: _t->mouseReleaseEvent(); break;
        case 4: _t->snapshot(); break;
        case 5: _t->CaptureDesktop(); break;
        case 6: _t->CaptureArea((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< QRect(*)>(_a[2]))); break;
        case 7: _t->updatehide(); break;
        case 8: _t->setBackground((*reinterpret_cast< QPixmap(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FormScreenshots::itemInserted)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject FormScreenshots::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FormScreenshots.data,
...
// SIGNAL 1
void FormScreenshots::itemInserted()
{
