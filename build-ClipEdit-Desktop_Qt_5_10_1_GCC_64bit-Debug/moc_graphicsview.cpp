...
#include "../sources/graphicsview.h"
...
void GraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemSelected((*reinterpret_cast< QGraphicsItem*(*)>(_a[1]))); break;
        case 1: _t->clear(); break;
        case 2: _t->contentToView(); break;
        case 3: _t->setZoomLevel((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->changeBackgroundColor(); break;
        default: ;
        }
        ...
        {
            typedef void (GraphicsView::*_t)(QGraphicsItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsView::itemSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GraphicsView::itemSelected(QGraphicsItem * _t1)
{
